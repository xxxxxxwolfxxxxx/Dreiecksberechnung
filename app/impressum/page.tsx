...
export default function Impressum() {
  return (
    <article className="prose dark:prose-invert max-w-2xl">
      ...
      <p><strong>E-Mail:</strong> Bitte über GitHub kontaktieren: <a href="https://github.com/xxxxxxwolfxxxxx" target="_blank" rel="noopener">github.com/xxxxxxwolfxxxxx</a></p>
